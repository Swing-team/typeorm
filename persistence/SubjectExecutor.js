                            ...
                            return tslib_1.__generator(this, function (_a) {
                                switch (_a.label) {
                                    ...
                                    case 3:
                                        ...
                                        if (!(subject.metadata.treeType === "materialized-path")) return [3 /*break*/, 5];
                                        return [4 /*yield*/, new MaterializedPathSubjectExecutor_1.MaterializedPathSubjectExecutor(this.queryRunner).update(subject)];
                                    case 4:
                                        _a.sent();
                                        _a.label = 5;
